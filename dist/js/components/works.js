const portfolioProjects = [
  { 
    ...
    timeline: [
      ...
      {stage: 'Production', desc: `As with my other works, Above the Line was essentially complete. As a tribute to the "editor", I illustrated a vector representation of it for the landing page. Apart from maintenance, Above the Line was ready for my portfolio.`},
  ...
  },
  {
    ...
    {stage: 'Feedback', desc: `From <a href="https://www.thinkful.com/" target="_blank" re="noopener noreferrer">Thinkful</a>, most of my feedback related to my JSX semantics. I asked scores of friends to give me honest feedback about features and the appearance. I ended up learning more about UI/UX while touching up the project's appearance.`},
    {stage: 'Production', desc: `After working out a few bugs, my project was ready for the portfolio. Occasionally, a bug might come up. But, in short, just-the-occasion.com does exactly what I need it to.`},
    {stage: 'New Insights', desc: `So much went into this project. My first fullstack web application was a rite of passage in my coding journey. I emerged with a revised boilerplate, an understanding of ES6, a new approach to project design, and a way to quickly create greeting cards.`}],
      tech: [  
      "React.js (Hooks & Context)",
      "JWT auth",
      "Node.js (Express)",
