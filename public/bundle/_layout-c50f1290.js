...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, file, 129, 10, 3461);
			attr_dev(li, "class", "svelte-9dozca");
			add_location(li, file, 128, 8, 3446);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(128:6) {#each links as [path, name]}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(ul, file, 126, 4, 3378);
			attr_dev(nav, "role", "navigation");
			add_location(nav, file, 120, 2, 3174);
			add_location(header, file, 116, 0, 3036);
		},
...
//# sourceMappingURL=_layout-c50f1290.js.map
