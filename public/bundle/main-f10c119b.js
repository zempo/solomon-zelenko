...
const layouts = {
  "/_layout": {
    "component": () => import('./_layout-3275ebd1.js').then(m => m.default),
    "meta": {},
    "relativeDir": "",
    "path": ""
  }
...
const _routes = [
  {
    "component": () => import('./delete-930df19f.js').then(m => m.default),
    "meta": {},
    "isIndex": false,
    "isFallback": false,
    "hasParam": false,
  ...
  {
    "component": () => import('./_fallback-f9a6cf9f.js').then(m => m.default),
    "meta": {},
    "isIndex": false,
    "isFallback": true,
    "hasParam": false,
  ...
  {
    "component": () => import('./about-e67ed77b.js').then(m => m.default),
    "meta": {},
    "isIndex": false,
    "isFallback": false,
    "hasParam": false,
  ...
  {
    "component": () => import('./[slug]-080e5791.js').then(m => m.default),
    "meta": {},
    "isIndex": false,
    "isFallback": false,
    "hasParam": true,
  ...
  {
    "component": () => import('./index-ee14fc0b.js').then(m => m.default),
    "meta": {},
    "isIndex": true,
    "isFallback": false,
    "hasParam": false,
  ...
  {
    "component": () => import('./index-be6e301a.js').then(m => m.default),
    "meta": {},
    "isIndex": true,
    "isFallback": false,
    "hasParam": false,
...
//# sourceMappingURL=main-f10c119b.js.map
