...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, file, 128, 10, 3529);
			attr_dev(li, "class", "svelte-9dozca");
			add_location(li, file, 127, 8, 3514);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(127:6) {#each links as [path, name]}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(ul, file, 125, 4, 3446);
			attr_dev(nav, "role", "navigation");
			add_location(nav, file, 119, 2, 3242);
			add_location(header, file, 115, 0, 3104);
		},
...
//# sourceMappingURL=_layout-fa849eb2.js.map
