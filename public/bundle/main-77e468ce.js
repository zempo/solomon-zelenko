...
const layouts = {
  "/_layout": {
    "component": () => import('./_layout-f19bd518.js').then(m => m.default),
    "meta": {},
    "relativeDir": "",
    "path": ""
  }
...
const _routes = [
  {
    "component": () => import('./delete-a3ea133c.js').then(m => m.default),
    "meta": {},
    "isIndex": false,
    "isFallback": false,
    "hasParam": false,
  ...
  {
    "component": () => import('./_fallback-bf637602.js').then(m => m.default),
    "meta": {},
    "isIndex": false,
    "isFallback": true,
    "hasParam": false,
  ...
  {
    "component": () => import('./about-8999cb7f.js').then(m => m.default),
    "meta": {},
    "isIndex": false,
    "isFallback": false,
    "hasParam": false,
  ...
  {
    "component": () => import('./[slug]-3a51bc7c.js').then(m => m.default),
    "meta": {},
    "isIndex": false,
    "isFallback": false,
    "hasParam": true,
  ...
  {
    "component": () => import('./index-27d3d3d4.js').then(m => m.default),
    "meta": {},
    "isIndex": true,
    "isFallback": false,
    "hasParam": false,
  ...
  {
    "component": () => import('./index-95e6ef17.js').then(m => m.default),
    "meta": {},
    "isIndex": true,
    "isFallback": false,
    "hasParam": false,
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(main, file$1, 110, 0, 2952);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=main-77e468ce.js.map
