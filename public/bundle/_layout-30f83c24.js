...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, file, 133, 10, 3520);
			attr_dev(li, "class", "svelte-1lciunb");
			add_location(li, file, 132, 8, 3505);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(132:6) {#each links as [path, name]}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(ul, file, 130, 4, 3437);
			attr_dev(nav, "role", "navigation");
			add_location(nav, file, 124, 2, 3233);
			add_location(header, file, 120, 0, 3095);
		},
...
//# sourceMappingURL=_layout-30f83c24.js.map
