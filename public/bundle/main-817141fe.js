...
const layouts = {
  "/_layout": {
    "component": () => import('./_layout-249cfe3a.js').then(m => m.default),
    "meta": {},
    "relativeDir": "",
    "path": ""
  }
...
const _routes = [
  {
    "component": () => import('./delete-12412d00.js').then(m => m.default),
    "meta": {},
    "isIndex": false,
    "isFallback": false,
    "hasParam": false,
  ...
  {
    "component": () => import('./_fallback-6a8d58ba.js').then(m => m.default),
    "meta": {},
    "isIndex": false,
    "isFallback": true,
    "hasParam": false,
  ...
  {
    "component": () => import('./about-39e549a4.js').then(m => m.default),
    "meta": {},
    "isIndex": false,
    "isFallback": false,
    "hasParam": false,
  ...
  {
    "component": () => import('./[slug]-82834cd7.js').then(m => m.default),
    "meta": {},
    "isIndex": false,
    "isFallback": false,
    "hasParam": true,
  ...
  {
    "component": () => import('./index-9c9dd780.js').then(m => m.default),
    "meta": {},
    "isIndex": true,
    "isFallback": false,
    "hasParam": false,
  ...
  {
    "component": () => import('./index-8d4d743a.js').then(m => m.default),
    "meta": {},
    "isIndex": true,
    "isFallback": false,
    "hasParam": false,
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(main, file$1, 113, 0, 2985);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=main-817141fe.js.map
