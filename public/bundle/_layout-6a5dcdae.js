...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(li, "class", "svelte-1j4f6ng");
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(ul, "class", "main-links svelte-1j4f6ng");
...
//# sourceMappingURL=_layout-6a5dcdae.js.map
