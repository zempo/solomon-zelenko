...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, file, 138, 10, 3592);
			attr_dev(li, "class", "svelte-1qjv4ta");
			add_location(li, file, 137, 8, 3577);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(137:6) {#each links as [path, name]}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(ul, "class", "main-links");
			add_location(ul, file, 135, 4, 3509);
			attr_dev(nav, "role", "navigation");
			add_location(nav, file, 129, 2, 3305);
			add_location(header, file, 125, 0, 3167);
		},
...
//# sourceMappingURL=_layout-3411879c.js.map
