...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, file, 146, 10, 3708);
			attr_dev(li, "class", "svelte-1qyleqn");
			add_location(li, file, 145, 8, 3693);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(ul, file, 143, 4, 3625);
			attr_dev(nav, "role", "navigation");
			add_location(nav, file, 137, 2, 3421);
			add_location(header, file, 133, 0, 3283);
		},
...
//# sourceMappingURL=_layout-6fcc75de.js.map
