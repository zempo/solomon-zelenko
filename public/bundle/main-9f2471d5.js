...
const layouts = {
  "/_layout": {
    "component": () => import('./_layout-b03da096.js').then(m => m.default),
    "meta": {},
    "relativeDir": "",
    "path": ""
  }
...
const _routes = [
  {
    "component": () => import('./delete-10ecfcea.js').then(m => m.default),
    "meta": {},
    "isIndex": false,
    "isFallback": false,
    "hasParam": false,
  ...
  {
    "component": () => import('./_fallback-44aa67f4.js').then(m => m.default),
    "meta": {},
    "isIndex": false,
    "isFallback": true,
    "hasParam": false,
  ...
  {
    "component": () => import('./about-273a7eeb.js').then(m => m.default),
    "meta": {},
    "isIndex": false,
    "isFallback": false,
    "hasParam": false,
  ...
  {
    "component": () => import('./[slug]-aff392e1.js').then(m => m.default),
    "meta": {},
    "isIndex": false,
    "isFallback": false,
    "hasParam": true,
  ...
  {
    "component": () => import('./index-5883689e.js').then(m => m.default),
    "meta": {},
    "isIndex": true,
    "isFallback": false,
    "hasParam": false,
  ...
  {
    "component": () => import('./index-f4e7ca20.js').then(m => m.default),
    "meta": {},
    "isIndex": true,
    "isFallback": false,
    "hasParam": false,
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(main, file$1, 110, 0, 2954);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=main-9f2471d5.js.map
