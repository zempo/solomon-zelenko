...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, file, 146, 10, 3706);
			attr_dev(li, "class", "svelte-1qyleqn");
			add_location(li, file, 145, 8, 3691);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(ul, file, 143, 4, 3623);
			attr_dev(nav, "role", "navigation");
			add_location(nav, file, 137, 2, 3419);
			add_location(header, file, 133, 0, 3281);
		},
...
//# sourceMappingURL=_layout-f7394f19.js.map
