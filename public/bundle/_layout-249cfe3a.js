...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, file, 137, 10, 3571);
			attr_dev(li, "class", "svelte-imtcyi");
			add_location(li, file, 136, 8, 3556);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(136:6) {#each links as [path, name]}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(ul, file, 134, 4, 3488);
			attr_dev(nav, "role", "navigation");
			add_location(nav, file, 128, 2, 3284);
			add_location(header, file, 124, 0, 3146);
		},
...
//# sourceMappingURL=_layout-249cfe3a.js.map
