...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, file, 134, 10, 3538);
			attr_dev(li, "class", "svelte-131nzda");
			add_location(li, file, 133, 8, 3523);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(133:6) {#each links as [path, name]}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(ul, file, 131, 4, 3455);
			attr_dev(nav, "role", "navigation");
			add_location(nav, file, 125, 2, 3251);
			add_location(header, file, 121, 0, 3113);
		},
...
//# sourceMappingURL=_layout-7034d2d8.js.map
