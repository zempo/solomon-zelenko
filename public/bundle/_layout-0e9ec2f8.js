...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, file, 129, 10, 3455);
			attr_dev(li, "class", "svelte-9dozca");
			add_location(li, file, 128, 8, 3440);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(ul, file, 126, 4, 3372);
			attr_dev(nav, "role", "navigation");
			add_location(nav, file, 120, 2, 3168);
			add_location(header, file, 116, 0, 3030);
		},
...
//# sourceMappingURL=_layout-0e9ec2f8.js.map
