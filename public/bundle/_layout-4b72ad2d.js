...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(li, "class", "svelte-xh25gb");
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(ul, "class", "main-links svelte-xh25gb");
...
//# sourceMappingURL=_layout-4b72ad2d.js.map
