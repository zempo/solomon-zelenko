...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, file, 133, 10, 3518);
			attr_dev(li, "class", "svelte-9dozca");
			add_location(li, file, 132, 8, 3503);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(ul, file, 130, 4, 3435);
			attr_dev(nav, "role", "navigation");
			add_location(nav, file, 124, 2, 3231);
			add_location(header, file, 120, 0, 3093);
		},
...
//# sourceMappingURL=_layout-0b7e4ac1.js.map
