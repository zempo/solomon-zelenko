...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, file, 142, 10, 3655);
			attr_dev(li, "class", "svelte-9moybi");
			add_location(li, file, 141, 8, 3640);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(141:6) {#each links as [path, name]}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(ul, file, 139, 4, 3572);
			attr_dev(nav, "role", "navigation");
			add_location(nav, file, 133, 2, 3368);
			add_location(header, file, 129, 0, 3230);
		},
...
//# sourceMappingURL=_layout-8a7547be.js.map
