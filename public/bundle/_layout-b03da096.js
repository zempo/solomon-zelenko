...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, file, 134, 10, 3540);
			attr_dev(li, "class", "svelte-zrb5li");
			add_location(li, file, 133, 8, 3525);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(ul, file, 131, 4, 3457);
			attr_dev(nav, "role", "navigation");
			add_location(nav, file, 125, 2, 3253);
			add_location(header, file, 121, 0, 3115);
		},
...
//# sourceMappingURL=_layout-b03da096.js.map
