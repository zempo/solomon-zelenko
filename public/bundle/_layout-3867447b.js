...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, file, 134, 10, 3601);
			attr_dev(li, "class", "svelte-9dozca");
			add_location(li, file, 133, 8, 3586);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(ul, file, 131, 4, 3518);
			attr_dev(nav, "role", "navigation");
			add_location(nav, file, 125, 2, 3314);
			add_location(header, file, 121, 0, 3176);
		},
...
//# sourceMappingURL=_layout-3867447b.js.map
