...
const layouts = {
  "/_layout": {
    "component": () => import('./_layout-eca2cbf9.js').then(m => m.default),
    "meta": {},
    "relativeDir": "",
    "path": ""
  }
...
const _routes = [
  {
    "component": () => import('./delete-49e8cec0.js').then(m => m.default),
    "meta": {},
    "isIndex": false,
    "isFallback": false,
    "hasParam": false,
  ...
  {
    "component": () => import('./_fallback-48f53360.js').then(m => m.default),
    "meta": {},
    "isIndex": false,
    "isFallback": true,
    "hasParam": false,
  ...
  {
    "component": () => import('./about-157a979f.js').then(m => m.default),
    "meta": {},
    "isIndex": false,
    "isFallback": false,
    "hasParam": false,
  ...
  {
    "component": () => import('./[slug]-587aecde.js').then(m => m.default),
    "meta": {},
    "isIndex": false,
    "isFallback": false,
    "hasParam": true,
  ...
  {
    "component": () => import('./index-b52612be.js').then(m => m.default),
    "meta": {},
    "isIndex": true,
    "isFallback": false,
    "hasParam": false,
  ...
  {
    "component": () => import('./index-6f163407.js').then(m => m.default),
    "meta": {},
    "isIndex": true,
    "isFallback": false,
    "hasParam": false,
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(main, file$1, 117, 0, 3039);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=main-34834b7b.js.map
