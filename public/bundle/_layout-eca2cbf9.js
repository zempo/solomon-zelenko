...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, file, 141, 10, 3625);
			attr_dev(li, "class", "svelte-1bbyuq1");
			add_location(li, file, 140, 8, 3610);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(140:6) {#each links as [path, name]}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(ul, file, 138, 4, 3542);
			attr_dev(nav, "role", "navigation");
			add_location(nav, file, 132, 2, 3338);
			add_location(header, file, 128, 0, 3200);
		},
...
//# sourceMappingURL=_layout-eca2cbf9.js.map
